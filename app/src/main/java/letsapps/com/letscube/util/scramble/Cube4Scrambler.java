...
public abstract class Cube4Scrambler {
    ...
    public static int generateRandomMove(){
        ...
        int randomTurnType = (int)(Math.random() * 6) + 1; // (entre 1 et 6 inclus)
        ...
        switch (randomTurnType){
            ...
            case 4: randomTurnType = (CubeNotations.Rw & CubeNotations.FILTER_TURN_TYPE); break;
            case 5: randomTurnType = (CubeNotations.Rw_CCW & CubeNotations.FILTER_TURN_TYPE); break;
            case 6: randomTurnType = (CubeNotations.Rw_2 & CubeNotations.FILTER_TURN_TYPE); break;
        }
